                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <label for="1">Only Text/Table</label> 
                                <input type="radio" id="2" name="type" value="2">
                                <label for="2">Switch Button</label><br><br>
                            ...
                            <?php 
                                if(isset($_POST['submit'])){
                                    ...
                                    $command = "bash code.sh ' . $topic. ''.$username.''.$password.'";
                                    $bash = shell_exec($command);

                                    $sql = mysqli_query($conn, "CREATE TABLE pd_{$nama} ( 
                                        id INT(50) NOT NULL AUTO_INCREMENT , 
                                        product_status INT(100) NOT NULL , 
                                        date TIMESTAMP on update CURRENT_TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , 
                                        PRIMARY KEY (id))"); 

                                    $insert = mysqli_query($conn, "INSERT INTO product (id , name, topic) VALUES(
                                        UUID(),
                                        '$nama',
                                        '$topic'
                                        ) ");
                            ...
                            ?> 
                            <br>
                            <a href="sup-admin.php"><button>Kembali</button> </a>
                        </div>
                    </div>
                </div>
            <!-- ============================================================== -->
